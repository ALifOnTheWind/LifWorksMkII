...
cat ./templates/top.html ./content/who.html ./templates/bottom.html > ./docs/who.html
cat ./templates/top.html ./content/wip.html ./templates/bottom.html > ./docs/wip.html